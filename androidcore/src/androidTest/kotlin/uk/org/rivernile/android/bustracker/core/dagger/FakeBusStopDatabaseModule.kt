...
/**
 * A module for providing fake implementations of bus stop database resources.
 *
 * @param busStopsDao An alternative [BusStopsDao] implementation. Defaults to fake implementation.
 * @author Niall Scott
 */
@Module
class FakeBusStopDatabaseModule(
    ...
    @Singleton
    @Provides
    fun provideBusStopsDao() = busStopsDao
}