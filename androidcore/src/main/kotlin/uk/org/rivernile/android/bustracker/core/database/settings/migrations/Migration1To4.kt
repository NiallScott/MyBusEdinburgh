...
/**
 * Perform a migration from version 1 to version 4 of the settings database. Version 1 is pre-Room.
 *
...
internal class Migration1To4 : Migration(1, 4) {
    ...
    /**
     * Create the `active_alerts` table.
     */
    private fun SupportSQLiteDatabase.createAlertsTable() {
        execSQL("""
