...
/**
 * Tests for `DiversionsScreen.kt`.
 *
 * @author Niall Scott
 */
class DiversionsScreenKtTest {
    ...
    fun nullActionDoesNotLaunchAnyActions() {
        ...
        val diversionsActionLauncher = FakeDiversionsActionLauncher(
            onLaunchUrl = launchUrlTracker
        )
        composeTestRule.setContent {
            MyBusThemeWithCompositionLocals(
                diversionsActionLauncher = diversionsActionLauncher
            ) {
                DiversionsScreen(
            ...
            MyBusThemeWithCompositionLocals(
                ...
                DiversionsScreen(
                    state = UiDiversionsState(
                        ...
                        action = UiDiversionAction.ShowUrl(url = "https://test.com/path")
                    ),
                    onRefresh = { },
                    onMoreDetailsClicked = { },
                    onActionLaunched = onActionLaunchedTracker,
    ...
    private fun MyBusThemeWithCompositionLocals(
        diversionsActionLauncher: DiversionsActionLauncher = FakeDiversionsActionLauncher(),
