...
/**
 * Tests for `DiversionItem.kt`.
 *
 * @author Niall Scott
 */
class DiversionItemKtTest {
    ...
    @Test
    fun diversionItemDisplaysItemWithNoMoreDetailsButtonAndNoAffectedServices() {
    ...
    @Test
    fun diversionItemDisplaysItemWithMoreDetailsButtonAndRespondsToClicks() {
        val lastUpdated = Instant.fromEpochMilliseconds(123L)
    ...
    @Test
    fun diversionItemDisplaysItemWithAffectedServices() {
        val lastUpdated = Instant.fromEpochMilliseconds(123L)
    ...
    @Test
    fun diversionItemDisplaysItemWithAffectedServicesAndMoreDetailsButton() {
        val lastUpdated = Instant.fromEpochMilliseconds(123L)
        val buttonClickedTracker = ButtonClickedTracker()
