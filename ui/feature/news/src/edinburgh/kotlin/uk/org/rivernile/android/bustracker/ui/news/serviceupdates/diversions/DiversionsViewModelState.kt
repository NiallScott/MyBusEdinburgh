...
/**
 * This class holds ViewModel state for diversions.
 *
 * @author Niall Scott
 */
@ViewModelScoped
internal class DiversionsViewModelState @Inject constructor() {

    /**
     * This [Flow] emits [UiDiversionAction]s to be performed, usually in response to the user's
     * actions.
     */
    val actionFlow: Flow<UiDiversionAction?> get() = _actionFlow
