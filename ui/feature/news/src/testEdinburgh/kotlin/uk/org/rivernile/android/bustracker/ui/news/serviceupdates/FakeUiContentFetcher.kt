...
internal class FakeUiContentFetcher(
    private val onDiversionsContentFlow: () -> Flow<UiContent<UiDiversion>> =
        { throw NotImplementedError() },
    private val onIncidentsContentFlow: () -> Flow<UiContent<UiIncident>> =
        { throw NotImplementedError() },
    private val onClose: () -> Unit = { throw NotImplementedError() }
) : UiContentFetcher {

    override val diversionsContentFlow get() = onDiversionsContentFlow()

    override val incidentsContentFlow get() = onIncidentsContentFlow()
