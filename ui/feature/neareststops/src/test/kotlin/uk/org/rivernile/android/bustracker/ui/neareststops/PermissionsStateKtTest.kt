...
/**
 * Tests for `PermissionsState.kt`.
 *
 * @author Niall Scott
 */
class PermissionsStateKtTest {

    @Test
    fun isPermissionsSufficientReturnsFalseWhenPermissionsUngranted() {
    ...
    @Test
    fun isPermissionsSufficientReturnsTrueWhenFineLocationGranted() {
        val permissionsState = PermissionsState(
    ...
    @Test
    fun isPermissionsSufficientReturnsTrueWhenCoarseLocationGranted() {
        val permissionsState = PermissionsState(
            fineLocationPermission = PermissionState.UNGRANTED,
    ...
    @Test
    fun isPermissionsSufficientReturnsTrueWhenAllPermissionsGranted() {
        val permissionsState = PermissionsState(
            fineLocationPermission = PermissionState.GRANTED,
            coarseLocationPermission = PermissionState.GRANTED
        )
