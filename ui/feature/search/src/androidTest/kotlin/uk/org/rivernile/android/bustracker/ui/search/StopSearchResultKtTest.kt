...
/**
 * Tests for `StopSearchResult.kt`.
 *
 * @author Niall Scott
 */
class StopSearchResultKtTest {
    ...
    fun dropdownIndicatorHasContentDescription() {
        ...
        val expectedText = composeTestRule
            .activity
            .getString(R.string.search_stop_dropdown_content_description)
    ...
    @Test
    fun stopSearchResultClickInvokesClickHandler() {
