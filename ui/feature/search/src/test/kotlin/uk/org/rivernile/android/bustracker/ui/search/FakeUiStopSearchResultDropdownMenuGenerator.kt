...
/**
 * A fake [UiStopSearchResultDropdownMenuGenerator] for testing.
 *
 * @author Niall Scott
 */
internal class FakeUiStopSearchResultDropdownMenuGenerator(
    private val onGetDropdownMenuItemsForStopsFlow:
        (Set<StopIdentifier>) -> Flow<Map<StopIdentifier, UiStopSearchResultDropdownMenu>?> =
