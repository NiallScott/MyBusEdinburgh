 ...
 * @author Niall Scott
 */
public sealed interface ServicesChooserParams : Parcelable {
     ...
     */
    public val selectedServices: List<ParcelableServiceDescriptor>?
     ...
     */
    @Parcelize
    public data class AllServices(
        @param:StringRes @get:StringRes override val titleResId: Int,
