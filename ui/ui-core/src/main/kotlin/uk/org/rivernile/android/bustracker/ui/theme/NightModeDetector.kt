 ...
 * @author Niall Scott
 */
public interface NightModeDetector {
     ...
     */
    public fun isNightMode(context: Context): Boolean
}

internal class RealNightModeDetector @Inject constructor() : NightModeDetector {

    override fun isNightMode(context: Context): Boolean {
