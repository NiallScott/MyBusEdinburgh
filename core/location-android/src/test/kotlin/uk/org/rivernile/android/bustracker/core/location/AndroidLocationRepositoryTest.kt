...
class AndroidLocationRepositoryTest {
    ...
    @Test
    fun userVisibleLocationFlowEmitsNoItemsWhenNoLocationFeature() = runTest {
        val repository = createRepository(
            androidLocationSupport = FakeAndroidLocationSupport(
    ...
    @Test
    fun userVisibleLocationFlowEmitsNoItemsWhenLocationIsNotEnabled() = runTest {
        val repository = createRepository(
            androidLocationSupport = FakeAndroidLocationSupport(
                onHasLocationFeature = { true },
    ...
    @Test
    fun userVisibleLocationFlowEmitsDeviceLocations() = runTest {
        val repository = createRepository(
            androidLocationSupport = FakeAndroidLocationSupport(
                onHasLocationFeature = { true },
                onIsLocationEnabledFlow = { flowOf(true) },
            ...
            locationSource = FakeLocationSource(
                onLocationUpdatesFlow = {
                    flowOf(
                        ...
                        LocationUpdate.Error.InsufficientLocationPermissions,
