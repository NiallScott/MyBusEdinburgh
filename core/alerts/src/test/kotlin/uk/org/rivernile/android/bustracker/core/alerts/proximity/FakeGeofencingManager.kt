...
/**
 * A fake [GeofencingManager] for testing.
 *
 * @author Niall Scott
 */
class FakeGeofencingManager(
    private val onAddGeofence: (Int, Double, Double, Float, Long) -> Unit =
        { _, _, _, _, _ -> throw NotImplementedError() },
    private val onRemoveGeofence: (Int) -> Unit = { throw NotImplementedError() }
) : GeofencingManager {
