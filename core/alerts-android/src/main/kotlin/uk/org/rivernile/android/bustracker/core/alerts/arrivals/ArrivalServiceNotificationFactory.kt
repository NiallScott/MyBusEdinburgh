...
/**
 * This is used to create any [Notification]s which are required by [ArrivalAlertRunnerService].
 *
 * @author Niall Scott
 */
internal interface ArrivalServiceNotificationFactory {
...
internal const val FOREGROUND_NOTIFICATION_ID = 100

internal class DefaultArrivalServiceNotificationFactory @Inject constructor(
    ...
    override fun createForegroundNotification(context: Context): Notification {
        return NotificationCompat
            ...
            .setContentTitle(
                context.getString(R.string.arrival_foreground_service_notification_title)
            )
    ...
    private fun createRemoveActionButtonPendingIntent(context: Context): PendingIntent {
        return Intent(context, RemoveArrivalAlertBroadcastReceiver::class.java)
            .let {
