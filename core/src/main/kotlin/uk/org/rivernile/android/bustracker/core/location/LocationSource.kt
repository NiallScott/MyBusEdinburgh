...
interface LocationSource {
    ...
    /**
     * Produce a [Flow] which emits the latest [DeviceLocation] until cancelled. This [Flow] may
     * emit `null` when location is not available for some reason, such as lack of permission.
     */
