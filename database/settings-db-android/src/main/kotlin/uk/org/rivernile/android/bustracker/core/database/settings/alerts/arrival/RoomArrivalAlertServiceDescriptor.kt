...
/**
 * This is a Room implementation of [ServiceDescriptor].
 *
 * @property serviceName See [ServiceDescriptor.serviceName].
 * @property operatorCode See [ServiceDescriptor.operatorCode].
 * @author Niall Scott
 */
internal class RoomArrivalAlertServiceDescriptor(
    @ColumnInfo("service_name") override val serviceName: String,
    ...
    override fun toString(): String {
        return "RoomArrivalAlertServiceDescriptor(serviceName='$serviceName', " +
