 ...
 * @author Niall Scott
 */
public interface FavouriteStop {

    /**
     * The stop for the favourite stop.
     */
    public val stopIdentifier: StopIdentifier

    /**
     * The name of the favourite stop.
     */
    public val stopName: String
}

/**
 * A [FavouriteStop] which can be inserted in to [FavouriteStopsDao].
 */
public data class InsertableFavouriteStop(
