...
/**
 * A fake [RoomBusStopDatabaseFactory] for testing.
 *
 * @author Niall Scott
 */
internal class FakeRoomBusStopDatabaseFactory(
    private val onCreateRoomBusStopDatabase: (String, Boolean) -> RoomBusStopDatabase =
