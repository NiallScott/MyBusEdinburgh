...
/**
 * The proxy implementation of [OperatorDao] which responds to the database opening/closing and
 * switches [kotlinx.coroutines.flow.Flow]s when this happens.
 *
 * @author Niall Scott
 */
@Singleton
internal class ProxyOperatorDao @Inject constructor(
    private val database: BusStopDatabase
) : OperatorDao {

    override val allOperatorNamesFlow get() = database.withFlowIfDatabaseIsOpenOrEmptyFlow {
        operatorDao.allOperatorNamesFlow
    }
}
