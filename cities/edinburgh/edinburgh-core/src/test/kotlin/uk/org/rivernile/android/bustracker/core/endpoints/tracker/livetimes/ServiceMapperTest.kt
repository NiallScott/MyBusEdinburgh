...
internal class ServiceMapperTest {
    ...
    @Test
    fun mapToServiceWithVehicleWithNullDisruptedSetsDisruptedToFalse() {
        whenever(busTime.timeDatas)
            .thenReturn(listOf(timeData1))
        whenever(busTime.serviceDisruption)
            .thenReturn(null)
        whenever(busTime.mnemoService)
            .thenReturn("100")
        whenever(vehicleMapper.mapToVehicle(timeData1))
    ...
    @Test
    fun mapToServiceWithVehicleWithNullDivertedSetsDivertedToFalse() {
        whenever(busTime.timeDatas)
            .thenReturn(listOf(timeData1))
        whenever(busTime.serviceDiversion)
            .thenReturn(null)
        whenever(busTime.mnemoService)
            .thenReturn("100")
        whenever(vehicleMapper.mapToVehicle(timeData1))
    ...
    @Test
    fun mapToServiceWithVehicleWhichCannotBeMappedDoesNotIncludeVehicle() {
        whenever(busTime.timeDatas)
