...
/**
 * A fake [ServiceUpdatesEndpoint] for tests.
 *
 * @author Niall Scott
 */
class FakeServiceUpdatesEndpoint(
    private val onGetServiceUpdates: () -> ServiceUpdatesResponse = { throw NotImplementedError() }
