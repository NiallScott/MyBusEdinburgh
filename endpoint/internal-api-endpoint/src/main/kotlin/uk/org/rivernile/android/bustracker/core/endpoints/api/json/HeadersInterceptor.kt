...
/**
 * This interceptor adds on the necessary headers for requests to the internal API.
 *
 * @param apiKeyGenerator Used to generate the API key.
 * @author Niall Scott
 */
internal class HeadersInterceptor @Inject constructor(
    ...
    private fun Request.getModifiedRequest(): Request {
        return newBuilder()
            .addHeader(HEADER_API_KEY, apiKeyGenerator.generateHashedApiKey())
            .build()
    }
}
