...
/**
 * A fake [ApiService] for testing.
 *
 * @author Niall Scott
 */
internal class FakeApiService(
    private val onGetDatabaseVersion: (String, Int) -> Response<JsonDatabaseVersion> =
    ...
    override suspend fun getDatabaseVersion(
        ...
        return onGetDatabaseVersion(appName, schemaVersion)
    }
}
