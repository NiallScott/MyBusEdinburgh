...
/**
 * This is used to track the permission state for [AddTimeAlertDialogFragment].
 *
...
class PermissionsTracker @Inject constructor(
    ...
    /**
     * A [kotlinx.coroutines.flow.Flow] which emits the current [PermissionsState], so that other
     ...
     * requested from the user, map this to a [PermissionsState].
     *
    ...
    private fun mapToPermissionsState(
        ...
        return PermissionsState(postNotificationsPermissionState)
    }
}