...
/**
 * This factory class is used to construct [StopClusterRenderer] instances
 *
 * @param stopMapMarkerDecorator An implementation used to decorate the map marker items.
