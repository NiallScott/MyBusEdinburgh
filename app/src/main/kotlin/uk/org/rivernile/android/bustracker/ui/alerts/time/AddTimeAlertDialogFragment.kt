...
class AddTimeAlertDialogFragment : DialogFragment(), ServicesChooserDialogFragment.Callbacks {
    ...
    override fun onServicesChosen(chosenServices: Array<out String>) {
        viewModel.selectedServices = chosenServices.asList()
    }
    ...
    private fun showServicesChooser(params: ServicesChooserParams) {
        ServicesChooserDialogFragment.newInstance(
                ...
                getString(R.string.addtimealertdialog_services_chooser_dialog_title)).apply {
                    setTargetFragment(this@AddTimeAlertDialogFragment, 0)
        }.show(parentFragmentManager, DIALOG_SELECT_SERVICES)
    }
