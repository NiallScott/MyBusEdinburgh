 ...
 * confirm with the user that they wish to delete a given stop from their
 * favourites.
 * 
 * @author Niall Scott
 */
public interface OnShowConfirmFavouriteDeletionListener {
    
    /**
     * This is called when it should be confirmed with the user that they want
     * to delete a favourite bus stop.
     * 
