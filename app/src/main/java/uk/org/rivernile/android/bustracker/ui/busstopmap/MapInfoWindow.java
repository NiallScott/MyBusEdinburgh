...
/**
 * The {@code MapInfoWindow} supplies a custom {@link View} for an {@code InfoWindow} when the bus
...
class MapInfoWindow implements GoogleMap.InfoWindowAdapter {
     ...
     * @param rootView The root {@link ViewGroup} to inflate against.
     */
    MapInfoWindow(@NonNull final Context context, @NonNull final ViewGroup rootView) {
    ...
    public View getInfoContents(final Marker marker) {
        if (cachedView == null) {
            ...
            txtTitle = (TextView) cachedView.findViewById(R.id.txtTitle);
            txtSnippet = (TextView) cachedView.findViewById(R.id.txtSnippet);
        }
