...
package uk.org.rivernile.android.bustracker.gradle.dagger
...
/**
 * This [Plugin] applies Dagger conventions to any module which applies it.
 *
 * @author Niall Scott
 */
public class DaggerConventionPlugin : Plugin<Project> {
    ...
    private fun Project.applyConventionPlugin() {
        ...
        dependencies.add("implementation", libs.findLibrary("dagger.core").get())
